...
import { CanvasRevealEffect } from "@/components/ui/CasvasRevealEffect";
  ...
  return (
    ...
    >
      ...
      <div className="relative z-20">
        ...
        <h2 className="text-sm dark:text-white opacity-0 group-hover/canvas-card:opacity-100 relative z-10 text-black mt-4  font-bold group-hover/canvas-card:text-white text-center group-hover/canvas-card:-translate-y-2 transition duration-200" style={{color:"#E4ECFF"  }} >
...
const AceternityIcon = ({order}:{order:string}) => {
  return (
    <div>
        ...
        <button className="text-2xl font-bold inline-flex h-12 animate-shimmer items-center justify-center rounded-md border border-slate-800 bg-[linear-gradient(110deg,#000319,45%,#1e2631,55%,#000319)] bg-[length:200%_100%] px-6 py-2 transition-colors focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50 text-white">
          {order}
        </button>
